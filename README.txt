...
3.) Deletes any rows that do not contain "Juvenile" in the item type column

4.) Deletes any rows that contain YA in the call number column (removes the young adult materials, which are cataloged as Juvie so that they are fine free)
